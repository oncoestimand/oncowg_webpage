...
## function to display
ind <- email[, "Type"] == "Industry" & email[, "Location"] != "Asia"
...
As of `r tod`, the working group 
 ...
 + has `r length(loc)` members (`r sum(loc == "EU")` from Europe and `r sum(loc == "NorAm")` from US) representing `r length(unique(com))` companies,
