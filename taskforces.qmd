...
## subteams
taskforces <- c("Clinical", "PS_switch", "PRO", "DOR", "FU", "RWD", "CondMarg", "T2E_sub", "early_dev_estimand_nexus", "Safety")
...
for (i in 1:length(taskforces)){
  ...
  if (active[i] == 1){
    ...
    if (i == 3){out2[[3]] <- paste(knit_expand('tools/taskforce.Rmd'), "[2021 summary on backfitting MMRM](talks/other/PRO TF (2021) Backfitting MMRM.pdf)", sep = "")}
  }
}
