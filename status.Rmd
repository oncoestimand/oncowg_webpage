...
As of `r tod`, the working group 
 ...
 + has `r length(loc)` members (`r sum(loc == "Europe")` from Europe, `r sum(loc == "NorAm")` from US, and `r sum(loc == "Asia")` from Asia) representing `r length(unique(com))` companies / institutions,
